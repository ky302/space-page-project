...
const Home = () => {
  return (
    <div id="home" className="bg-hero bg-cover">
      <NavigasiBar />
      <div className=" box-border mx-auto max-w-5xl text-white grid grid-cols-1 lg:grid-cols-2 ">
        <div className=" order-2 lg:order-1 flex items-center justify-center lg:justify-start py-8 lg:py-20 ">
          <div className=" space-y-5 font-exo w-3/4">
            ...
            <p className=" lg:text-left leading-4 text-xs text-justify text-slate-300">
